...
<title>Tambah Metode - Print & Copy</title>
...
<div class="flex min-h-screen">
        ...
        <nav class="flex-1 px-3 py-4 space-y-1 text-sm">
            ...
            <div>
                ...
                <div id="inventorySubmenu" class="ml-8 mt-1 space-y-1">
                    ...
                    <a href="/method" class="block px-3 py-1.5 rounded-md text-sm bg-white text-blue-700 font-semibold">Tambah Metode</a>
                </div>
            </div>
    ...
    <div class="flex-1 flex flex-col">
        <header class="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-6">
            <h1 class="font-semibold text-lg text-slate-700">Inventory - Tambah Metode</h1>
        ...
        <main class="flex-1 p-6 space-y-6">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
                <h2 class="font-semibold text-slate-700 mb-4">Tambah Metode</h2>

                <form id="methodForm" class="grid grid-cols-1 sm:grid-cols-4 gap-4">
                    <div class="sm:col-span-3">
                        <label class="block text-sm font-medium text-slate-600 mb-1">Nama Metode</label>
                        <input type="text" id="methodName" required placeholder="ex: Print Hitam Putih"
                               class="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-slate-600 mb-1">Harga / Lembar</label>
                        <input type="number" id="methodPrice" min="0" required placeholder="0"
                               class="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
            ...
            <!-- TABEL -->
            <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
                <h2 class="font-semibold text-slate-700 mb-4">Daftar Metode</h2>
                <div class="overflow-x-auto">
                    <table class="w-full text-sm">
                        <thead>
                            <tr class="text-left text-slate-400 border-b border-slate-100">
                                <th class="py-2 pr-4">Nama Metode</th>
                                <th class="py-2 pr-4">Harga / Lembar</th>
                            </tr>
                        </thead>
                        <tbody id="methodsTableBody">
                            <tr class="border-b border-slate-50">
                                <td class="py-3 pr-4 font-medium text-slate-700">Print Hitam Putih</td>
                                <td class="py-3 pr-4">Rp 500</td>
                            </tr>
                            <tr class="border-b border-slate-50">
                                <td class="py-3 pr-4 font-medium text-slate-700">Print Berwarna</td>
                                <td class="py-3 pr-4">Rp 1.500</td>
                            </tr>
                            <tr class="border-b border-slate-50">
                                <td class="py-3 pr-4 font-medium text-slate-700">Fotocopy Hitam Putih</td>
                                <td class="py-3 pr-4">Rp 300</td>
                            </tr>
                            <tr class="border-b border-slate-50">
                                <td class="py-3 pr-4 font-medium text-slate-700">Fotocopy Berwarna</td>
                                <td class="py-3 pr-4">Rp 1.200</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('methodForm').addEventListener('submit', function (e) {
        ...
        const price = parseInt(document.getElementById('methodPrice').value, 10);
